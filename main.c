...
int main()
{
    ...
    int continue_game = 0;
    char table_values[NUMBEROFROUNDS];
    int i;
    ...
    for(i=0; i < NUMBEROFROUNDS; i++) //boucle pour initialiser le tableau
    {
        table_values[i] = '-';
    }
    ...
    while(continue_game < NUMBEROFROUNDS)
    {
        ...
        case 13:
            ...
            table_values[12] = intToChar(result);
...
void show_menu(char* table, int total, int bonus, int total_general)
{
    ...
    if (table[8] == '-')
    {
        printf("9.  FULL HOUSE    :   %c\n", table[8]);
    }
    else
    {
        printf("9.  FULL HOUSE    :   %i\n", charToInt(table[8]));
    }

    if (table[9] == '-')
    {
        printf("10. PETITE SUITE  :   %c\n", table[9]);
    }
    else
    {
        printf("10. PETITE SUITE  :   %i\n", charToInt(table[9]));
    }

    if (table[10] == '-')
    {
        printf("11. GRANDE SUITE  :   %c\n", table[10]);
    }
    else
    {
        printf("11. GRANDE SUITE  :   %i\n", charToInt(table[10]));
    }
...
void small_suite(int* dices, char* table, int* total_general)
{
    ...
    else if(counts[3] != 0 && counts[4] != 0 && counts[5] != 0 && counts[6] != 0)
    {
        small_Suite = 1;
    }
